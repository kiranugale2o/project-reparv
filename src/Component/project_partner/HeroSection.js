    ...
    >
      <div className="flex w-full  md:w-full  ">
        <div className="flex flex-col">
          ...
          {/* Text Content */}
          <div className="md:mt-7 absolute flex flex-col items-start p-5 lg:p-0  w-full gap-6 lg:w-[486px] h-[164px] lg:left-[152px] lg:top-[144px] top-[91px]">
            {" "}
        ...
        {/* Register Button */}
        <div className=" absolute w-[237px] flex flex-row justify-center items-center p-[14px_24px] gap-[1px] h-[48px] lg:h-[58px] left-[17%]  md:left-[40%]  lg:left-[152px] top-[550px] lg:top-[371px] bg-[#0BB501]    rounded-[8px]">
          <a
        ...
        {/* HeroSection Video */}
        <div className=" flex flex-col ">
          <div className="absolute w-[350px]    md:left-[10%] md:w-[380px] px-3 lg:p-0 lg:w-[500px] h-[250px]  lg:left-[60%] lg:top-[154px] top-[280px] filter drop-shadow-[0px_4px_8px_rgba(0,_0,_0,_0.1)]">
            <img src="/hero_section_video.png" alt="video" />
            {/* Video icon svg */}
            <div className="absolute w-[57.71px] h-[65.49px] left-[150px] lg:left-[225.06px] top-[70px] lg:top-[109.66px] ">
              <img src="/videoicon.png" alt="videoIcon" />
            </div>
          </div>
        </div>

        <div className="hidden md:flex lg:flex absolute flex flex-col items-start md:p-5 lg:p-[24px] gap-[12px] lg:w-[250px] h-[124px] md:left-[570px] lg:left-[920px] md:top-[390px] lg:top-[455px] bg-[rgba(255,_255,_255,_0.4)] backdrop-blur-[25px] rounded-[12px]">
          {/* Partner with Reparv*/}
