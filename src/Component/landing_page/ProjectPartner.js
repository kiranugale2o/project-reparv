export default function ProjectPartner() {
  return (
    <div class="absolute flex flex-col items-center p-0 gap-8 w-full  h-[518px]   top-[650px] md:top-[700px] lg:top-[700px]">
      ...
      <div class="join absolute   w-[360px]  rounded-lg   lg:ml-0 md:w-[359px] md:left-[30%] lg:left-[22%] lg:mx-auto   lg:w-[747px] h-[200px] lg:h-[334px]  lg:justify-center lg:top-[184px] top-[170px] bg-[url('/project_partner.png')] bg-contain bg-cover ">
