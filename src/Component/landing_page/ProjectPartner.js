...
//   return (
//     <div class="absolute flex flex-col items-center p-0 gap-8 w-full  h-[518px]   top-[250px] md:top-[700px] lg:top-[700px]">
...
//               <div class="w-full  lg:w-[427px] h-[72px] text-center   text-[#999999] lg:text-[#00000066] text-[16px] leading-[19px] lg:leading-[160%]  ">
...
//                   Partner with Reparv to access exclusive real estate
//                   opportunities and grow your business with our support.
//                 </p>
//               </div>
//             </div>
//           </div>
