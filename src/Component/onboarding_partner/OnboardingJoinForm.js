...
export default function OnboardingJoinFormSection() {
  ...
  return (
    <>
      <div
        id="onboardingjoin"
        className=" absolute flex flex-col w-full  lg:p-2 lg:items-center gap-[32px]  h-[867px] lg:h-[1027px] lg:top-[3703px] top-[5500px]"
      >
        {/* Form title */}
        ...
        <div className="  box-border  md:ml-0  lg:ml-10 lg:ml-0 lg:left-[1%] flex flex-col items-center w-full   p-5 lg:p-[32px] lg:px-[36px] lg:gap-[24px] lg:w-[703px] h-[980px] lg:h-[707px] bg-white border border-[#0000001a] rounded-[10px]">
          {/* Register as Onboarding partner Your Interest */}
          <div className="hidden lg:flex lg:w-[235px]  h-[36px] font-inter font-medium text-[24px] lg:leading-[150%] text-center text-[#F97316]">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Submit Button */}
            <div className="flex mx-auto mt-10 lg:mt-5 flex-row justify-center items-center p-[20px] px-[34px] gap-[67px] w-[151px] h-[32px] bg-[#F97316] rounded-[6px]">
              <button
                type="submit"
